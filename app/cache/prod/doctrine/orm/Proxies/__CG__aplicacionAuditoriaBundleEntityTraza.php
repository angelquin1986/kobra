...
namespace Proxies\__CG__\aplicacion\AuditoriaBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Traza extends \aplicacion\AuditoriaBundle\Entity\Traza implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Traza $proxy) {
