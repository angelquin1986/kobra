 ...
 */
class Feriado extends \aplicacion\BaseBundle\Entity\Feriado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'aplicacion\\BaseBundle\\Entity\\Feriado' . "\0" . 'id', '' . "\0" . 'aplicacion\\BaseBundle\\Entity\\Feriado' . "\0" . 'inicio', '' . "\0" . 'aplicacion\\BaseBundle\\Entity\\Feriado' . "\0" . 'fin', '' . "\0" . 'aplicacion\\BaseBundle\\Entity\\Feriado' . "\0" . 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Feriado $proxy) {
