 ...
 */
class Agente extends \aplicacion\EmisionesBundle\Entity\Agente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'aplicacion\\EmisionesBundle\\Entity\\Agente' . "\0" . 'agencia', '' . "\0" . 'aplicacion\\EmisionesBundle\\Entity\\Agente' . "\0" . 'ordenes', 'nombre', 'apellidos', 'ci', 'sexo', 'celular', 'telefono', 'ext', 'grupos', 'foto', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Agente $proxy) {
