 ...
 */
class Anulacion extends \aplicacion\EmisionesBundle\Entity\Anulacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Anulacion $proxy) {
    ...
    public function setVtc($vtc)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVtc', array($vtc));

        return parent::setVtc($vtc);
    }
    ...
    public function getVtc()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVtc', array());

        return parent::getVtc();
    }
