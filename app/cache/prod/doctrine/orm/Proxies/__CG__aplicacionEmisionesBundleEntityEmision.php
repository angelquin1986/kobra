 ...
 */
class Emision extends \aplicacion\EmisionesBundle\Entity\Emision implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Emision $proxy) {
