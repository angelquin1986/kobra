 ...
 */
class Pagodirecto extends \aplicacion\EmisionesBundle\Entity\Pagodirecto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'tipoPago', 'valor', 'orden');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pagodirecto $proxy) {
