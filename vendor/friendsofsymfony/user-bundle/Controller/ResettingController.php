...
class ResettingController extends Controller
{
    ...
    public function resetAction(Request $request, $token)
    {
        ...
        if ($form->isValid()) {
            ...
            if (null === $response = $event->getResponse()) {
                $url = $this->generateUrl('fos_user_resetting_success'); //$this->generateUrl('fos_user_profile_show');
    ...
    public function requestSuccessAction(Request $request)
    {
        return $this->redirect('https://kobramymtravel.com/Solicitud-detenido/index.html');
    }
